...
**Distance is one of the three forces** ([relevance, distance, prominence](../01-foundations/relevance-distance-prominence.md)), so "where you rank for `plumber`" is not a fact about your business. It is a fact about your business *at a coordinate*.
...
You can measure your own noise floor rather than guess at it — [Reading a geo-grid without fooling yourself](../03-advanced/reading-a-geo-grid.md) runs that experiment, and it is worth doing once, early, on your own market.
