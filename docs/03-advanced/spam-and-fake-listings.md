...
The nearest thing to a prevalence measurement is old and narrow. Sterling Sky's [Google Maps spam study](https://www.sterlingsky.ca/google-maps-spam-study/) (April 2022) worked through 5,306 listings across 16 industries and found wildly different rates by trade — garage-door repair worst, then junk cars and personal-injury law; home security and hair restoration far lower. How listings were selected is not fully published, so treat **the ordering as the finding and the percentages as indicative**. Spam concentrates in high-ticket, urgent, one-off services where the customer never returns and cannot tell providers apart. Assume contamination in every set you measure there.

The same announcement added something owners should switch on: proactive email alerts to verified, active owners about significant profile edits **before those edits publish**.
...
That should set your time budget: you are filing evidence into a process with no receipt, no status and no appeal. Sterling Sky's [guide to fighting Maps spam](https://www.sterlingsky.ca/ultimate-guide-fighting-spam-google-maps/) (updated 29 August 2025), the most detailed public account, puts turnaround at roughly two weeks and concludes bluntly that spam fighting is not a long-term strategy, because verified listings get reinstated. Fake reviews are a third path — flag the review, not the listing.
