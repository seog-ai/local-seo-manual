...
| --- | --- | --- | --- | --- | --- |
| [LSM-REVIEWS-01](#lsm-reviews-01--2026-07-24--reviews-api-exposes-reviewreplyurl) | 2026-07-24 | GBP Reviews `get` / `list` / `batchGetReviews` | `reviewReplyUrl` added | — | WORKS |
| [LSM-POSTS-01](#lsm-posts-01--2026-07-22--the-v4-local-posts-api-is-alive) | 2026-07-22 | v4 `accounts.locations.localPosts` | (nothing — it is alive) | Third-party guides claiming it died in 2022 | WORKS |
| [LSM-POSTS-02](#lsm-posts-02--2026-07-22--scheduledtime-is-writable--google-publishes-the-post-itself) | 2026-07-22 | v4 `localPosts.create` | `scheduledTime` accepted and echoed | Home-built post schedulers are redundant | UNDOCUMENTED |
| [LSM-POSTS-03](#lsm-posts-03--2026-07-22--post-length-limits-are-enforced-but-scrubbed-from-the-docs) | 2026-07-22 | v4 `localPosts.create` | `summary` ≤1500, `event.title` ≤58 | Over-length drafts are rejected on submit | UNDOCUMENTED |
| [LSM-GBP-01](#lsm-gbp-01--2026-07-13--place-actions-api-is-the-one-that-is-off-by-default) | 2026-07-13 | Place Actions API v1 | Not enabled with the others | Every call fails until it is enabled in the console | UNDOCUMENTED |
| [LSM-POLICY-01](#lsm-policy-01--2026-07-10--powered-by-google-no-longer-exists-attribution-is-google-maps) | 2026-07-10 | Places API policies | "Powered by Google" retired | Every UI, PDF and email still showing it | GONE |
| [LSM-REVIEWS-02](#lsm-reviews-02--2026-07-01--rejected-review-replies-now-say-why) | 2026-07-01 | GBP `ReviewReply` | `PolicyViolation` added | — | WORKS |
| [LSM-PLACES-01](#lsm-places-01--2026-06-29--the-field-mask-decides-the-sku--same-call-0-or-35-per-1000) | 2026-06-29 | Places `places:searchText`, `places/{id}` | Field-mask billing tiers restated | Cost models that price by endpoint | WORKS |
| [LSM-POLICY-02](#lsm-policy-02--2026-06-23--the-places-caching-allowance-has-not-widened-since-may-2025) | 2026-06-23 | GMP ToS §3.2.3 / SST §14.3, §A.3 | Nothing (that is the finding) | Architectures built on a "30-day Places cache" | WORKS |
| [LSM-GBP-02](#lsm-gbp-02--2026-05-12--pending-invitations-now-carry-a-place-id) | 2026-05-12 | GBP Invitations `TargetLocation` | Place ID exposed | — | WORKS |
| [LSM-REVIEWS-03](#lsm-reviews-03--2026-04-20--review-photos-and-videos-are-readable-through-the-api) | 2026-04-20 | GBP Reviews | `ReviewMediaItem` added | — | WORKS |
| [LSM-POSTS-04](#lsm-posts-04--2026-04-07--local-posts-gained-native-recurrence) | 2026-04-07 | v4 `LocalPost` | `RecurrenceInfo` added | The "v4 is abandoned" assumption | WORKS |
| [LSM-REVIEWS-04](#lsm-reviews-04--2026-04-01--reply-moderation-state-became-readable) | 2026-04-01 | GBP `ReviewReply` | `ReviewReplyState` added | Tools reporting "reply published" on submit | WORKS |
| [LSM-PLACES-02](#lsm-places-02--2026-03-17--places-can-return-businesses-that-have-not-opened-yet) | 2026-03-17 | Places search + Place Details | `includeFutureOpeningBusinesses`, `openingDate` | Competitor counts that silently exclude them | WORKS |
| [LSM-PLACES-03](#lsm-places-03--2026-02-12--180-new-place-types-and-a-display-label-field) | 2026-02-12 | Places search + Place Details | 180 types, `googleMapsTypeLabel` | Hard-coded category maps | WORKS |
| [LSM-GBP-03](#lsm-gbp-03--2025-12-03--the-public-qa-panel-started-disappearing-from-profiles) | 2025-12-03 | Consumer profile surface | Q&A panel → Gemini "Ask" | Seeded Q&A, and every audit that scored it | GONE |
| [LSM-GBP-04](#lsm-gbp-04--2025-11-03--the-qa-api-was-discontinued) | 2025-11-03 | My Business Q&A API; Notifications Q&A types | Discontinued | Q&A monitoring and posting tools | GONE |
| [LSM-PLACES-04](#lsm-places-04--2025-10-20--places-tells-you-when-a-business-moved) | 2025-10-20 | Place Details | `movedPlace`, `movedPlaceId` | Rank trackers holding a stale place ID | WORKS |
| [LSM-POLICY-03](#lsm-policy-03--2025-08-28--gbp-api-content-may-be-stored-for-30-calendar-days-and-not-aggregated) | 2025-08-28 | Business Profile APIs policies | Storage cap restated | Indefinite review-history archives | WORKS |
| [LSM-AI-01](#lsm-ai-01--2025-06-05--ai-mode-became-generally-available-in-the-us) | 2025-06-05 | Google Search (AI Mode) | Labs → general US release | Pre-2025 SERP-composition baselines | WORKS |
| [LSM-AI-02](#lsm-ai-02--2025-05-20--gemini-25-went-under-ai-mode-and-ai-overviews) | 2025-05-20 | AI Mode / AI Overviews | Model swap | AI-visibility rates measured before it | WORKS |
| [LSM-PLACES-05](#lsm-places-05--2025-05-08--google-generated-place-and-review-summaries-reached-ga) | 2025-05-08 | Place Details | AI summaries GA | Field masks that pulled them for free in preview | WORKS |
| [LSM-AI-03](#lsm-ai-03--2025-03-05--ai-overviews-in-the-us-moved-to-gemini-20) | 2025-03-05 | AI Overviews | Model swap | — | WORKS |
| [LSM-PLACES-06](#lsm-places-06--2025-03-01--maps-platform-pricing-was-restructured-and-legacy-places-was-frozen) | 2025-03-01 | All Maps Platform SKUs; Places API (Legacy) | $200 credit → per-SKU free caps; legacy frozen | New projects cannot enable legacy Places | WORKS |
| [LSM-PLACES-07](#lsm-places-07--2024-11-07--pure-service-area-businesses-became-findable-if-you-ask) | 2024-11-07 | `places:searchText`, Autocomplete | `includePureServiceAreaBusinesses` | Every SAB search that omits the flag | WORKS |
| [LSM-GBP-05](#lsm-gbp-05--2024-07-31--business-profile-chat-and-call-history-were-shut-down) | 2024-07-31 | Business Messages; call history | Shut down | Chat-response-rate reporting | GONE |
| [LSM-GBP-06](#lsm-gbp-06--2024-07-01--health-provider-attributes-and-insurance-networks-were-discontinued) | 2024-07-01 | v4 health attrs, `insuranceNetworks` | Discontinued, no replacement | Healthcare listing tools | GONE |
| [LSM-PLACES-08](#lsm-places-08--2024-05-28--autocomplete-new-reached-ga-with-session-token-billing) | 2024-05-28 | `places:autocomplete` | Session tokens | Untokenised autocomplete billing | WORKS |
| [LSM-PLACES-09](#lsm-places-09--2024-05-13--maxresultcount-was-deprecated-in-favour-of-pagesize) | 2024-05-13 | Places search requests | `maxResultCount` deprecated | Nothing yet — it still works | OPEN QUESTION |
| [LSM-POLICY-04](#lsm-policy-04--2024-02-15--limited-use-covers-derived-and-aggregated-oauth-data-too) | 2024-02-15 | Google API Services User Data Policy | Current revision | "It's only aggregates" defences | WORKS |
| [LSM-GBP-07](#lsm-gbp-07--2023-05-30--the-business-calls-api-and-location-association-were-discontinued) | 2023-05-30 | Business Calls API; `locations.associate` | Discontinued | Call-tracking and place-linking flows | GONE |
| [LSM-POSTS-05](#lsm-posts-05--2023-03-30--per-post-metrics-left-with-reportinsights-and-never-came-back) | 2023-03-30 | v4 `reportInsights` | Sunset | Per-post performance reporting, permanently | GONE |
| [LSM-PLACES-10](#lsm-places-10--2023-05--autocomplete-bounds-location-and-radius-were-deprecated) | 2023-05 | Autocomplete request options | → `locationBias` / `locationRestriction` | Copy-pasted 2022 autocomplete code | GONE |
| [LSM-PLACES-11](#lsm-places-11--2020-05-26--permanently_closed-was-deprecated-and-tools-still-read-it) | 2020-05-26 | Places `permanently_closed` | → `business_status` | Audits that call a closed business open | GONE |
| [LSM-AI-04](#lsm-ai-04--undated--the-models-behind-the-ai-surfaces-change-without-a-changelog) | undated | AI Overviews / AI Mode / assistants | Unannounced model swaps | Any AI-visibility trend line | OPEN QUESTION |

---

## 2026

### LSM-REVIEWS-01 · 2026-07-24 · Reviews API exposes `reviewReplyUrl`
...
### LSM-POSTS-01 · 2026-07-22 · The v4 Local Posts API is alive
...
### LSM-POSTS-02 · 2026-07-22 · `scheduledTime` is writable — Google publishes the post itself
...
### LSM-POSTS-03 · 2026-07-22 · Post length limits are enforced but scrubbed from the docs
...
### LSM-GBP-01 · 2026-07-13 · Place Actions API is the one that is off by default
...
### LSM-POLICY-01 · 2026-07-10 · "Powered by Google" no longer exists; attribution is "Google Maps"

**Verdict:** GONE  
**Last verified:** 2026-07-16  
**API touched:** Places API display requirements (policy, not endpoint)  
**Probe:** Search the full text of the three controlling documents — the Places API policies page (stamped 2026-07-10 UTC), the Maps Platform Terms of Service (last modified 2026-06-23) and the Service Specific Terms (last modified 2026-06-10). The string "Powered by Google" appears in none of them.

Attribution is now the Google Maps logo, or where space is constrained the exact text **"Google Maps"** — untranslated, unwrapped, not re-capitalised. Existing "Google" attributions are tolerated for now, but new implementations are expected to use the current form.
...
### LSM-REVIEWS-02 · 2026-07-01 · Rejected review replies now say why
...
**Consequence:** Surface the violation reason to whoever wrote the reply. Combined with [LSM-REVIEWS-04](#lsm-reviews-04--2026-04-01--reply-moderation-state-became-readable), it is now possible to report reply status honestly instead of assuming that submitted means published.

### LSM-PLACES-01 · 2026-06-29 · The field mask decides the SKU — same call, $0 or $35 per 1,000

**Verdict:** WORKS  
**Last verified:** 2026-07-03  
**API touched:** `places:searchText`, `places:searchNearby`, `places/{id}` — all Places API (New) reads  
**Probe:** Compare Google's SKU details and pricing pages (Places API (New) table, stamped "Last updated 2026-06-29") against your own field masks. Then run the same `places:searchText` twice, once with a mask of `places.id` and once with a mask containing `rating` or `nationalPhoneNumber`, and compare the SKUs billed.

Places bills a request at the **highest SKU touched by any field in its mask**, at the volume tier reached. A Text Search returning only `places.id` bills the Essentials (IDs Only) SKU at $0. Add `rating` or `nationalPhoneNumber` to the same call and it bills Text Search Enterprise at $35 per 1,000. Adding `reviews` or attribute fields to a Place Details call moves it to Enterprise + Atmosphere at $25 per 1,000.

**Consequence:** Price your work by field mask, not by endpoint. A geo-grid rank scan needs ranked *identities* only, so an IDs-only mask makes the search itself free while a rich mask makes it the most expensive operation you run. Full SKU mapping is in [What Google's APIs actually cost](./what-googles-apis-cost.md).

### LSM-POLICY-02 · 2026-06-23 · The Places caching allowance has not widened since May 2025

**Verdict:** WORKS  
**Last verified:** 2026-07-16  
**API touched:** Places API storage rights (ToS §3.2.3(a)/(b), SST §B.14.3, §A.3)  
**Probe:** Diff the current Service Specific Terms (last modified 2026-06-10) against the archived 2025-05-01 version at `cloud.google.com/archive/maps-platform/terms/maps-service-terms-20250501`. The Places caching grant is unchanged in substance.

The only express permissions remain place IDs, storable indefinitely, and latitude/longitude for up to 30 consecutive calendar days with mandatory deletion after. Names, addresses, ratings, review counts, review text, hours and photo metadata are not covered by any storage grant. The March 2025 SKU restructuring ([LSM-PLACES-06](#lsm-places-06--2025-03-01--maps-platform-pricing-was-restructured-and-legacy-places-was-frozen)) changed pricing only. The widely-repeated "30-day Places caching allowance" is not in either version.
...
### LSM-GBP-02 · 2026-05-12 · Pending invitations now carry a place ID

**Verdict:** WORKS  
**Last verified:** 2026-07-27  
**API touched:** Business Profile Account Management — invitations, `TargetLocation`  
**Probe:** Fetch `developers.google.com/my-business/content/latest-updates` and read the 2026-05-12 entry.
...
### LSM-REVIEWS-03 · 2026-04-20 · Review photos and videos are readable through the API
...
**Consequence:** Customer-supplied review media becomes auditable. Note that any Google-supplied attribution strings must be displayed wherever the media appears ([LSM-POLICY-01](#lsm-policy-01--2026-07-10--powered-by-google-no-longer-exists-attribution-is-google-maps)).

### LSM-POSTS-04 · 2026-04-07 · Local Posts gained native recurrence
...
### LSM-REVIEWS-04 · 2026-04-01 · Reply moderation state became readable
...
### LSM-PLACES-02 · 2026-03-17 · Places can return businesses that have not opened yet

**Verdict:** WORKS  
**Last verified:** 2026-07-27  
**API touched:** Places API (New) — `includeFutureOpeningBusinesses` request parameter, `openingDate` field  
**Probe:** Fetch `developers.google.com/maps/documentation/places/web-service/release-notes` and read the 2026-03-17 entry (page stamped 2026-07-20 UTC).

Search can now include businesses expected to open soon, and Place Details can return an anticipated `openingDate`.
...
### LSM-PLACES-03 · 2026-02-12 · 180 new place types, and a display-label field
...
### LSM-GBP-03 · 2025-12-03 · The public Q&A panel started disappearing from profiles
...
### LSM-GBP-04 · 2025-11-03 · The Q&A API was discontinued

**Verdict:** GONE  
**Last verified:** 2026-07-13  
**API touched:** My Business Q&A API; Notifications API types `NEW_QUESTION`, `NEW_ANSWER`, `UPDATED_QUESTION`, `UPDATED_ANSWER`  
**Probe:** Call any Q&A endpoint with a valid `business.manage` token. It returns HTTP 501. Google's own change log (`developers.google.com/my-business/content/qanda/change-log`, stamped 2025-11-06 UTC) states: "The My Business Q&A API was discontinued on November 3, 2025. You can no longer read or post questions and answers using the API."

Notice was 49 days: the shutdown was announced on 2025-09-15. The four Q&A notification types were deprecated at the same time.

**Consequence:** Never build on Q&A. If you subscribe to Business Profile notifications, drop the four Q&A types from your handler — a 501 on a scheduled job is the kind of error that gets muted and then forgotten. Note the pattern for planning purposes: seven weeks' notice, and the deprecation notice on the main API page did not mention it.

### LSM-PLACES-04 · 2025-10-20 · Places tells you when a business moved
...
### LSM-POLICY-03 · 2025-08-28 · GBP API content may be stored for 30 calendar days, and not aggregated
...
There is no written carve-out for the merchant's own data obtained through the merchant's own OAuth grant. Note the date: the Business Profile deprecation schedule at `developers.google.com/my-business/content/sunset-dates` carries the same 2025-08-28 stamp and, when fetched on 2026-07-27, still did not list the Q&A API shutdown that landed ten weeks after it ([LSM-GBP-04](#lsm-gbp-04--2025-11-03--the-qa-api-was-discontinued)). The deprecation page is not a reliable early warning.
...
### LSM-AI-01 · 2025-06-05 · AI Mode became generally available in the US

**Verdict:** WORKS  
**Last verified:** 2026-07-27  
**API touched:** Google Search consumer surface — no API  
**Probe:** Google's Search blog and the I/O 2025 announcements; AI Mode entered Search Labs in the US in March 2025 and was released to all US users on 2025-06-05, reaching 180 countries and territories subsequently.
...
### LSM-AI-02 · 2025-05-20 · Gemini 2.5 went under AI Mode and AI Overviews
...
### LSM-PLACES-05 · 2025-05-08 · Google-generated place and review summaries reached GA

**Verdict:** WORKS  
**Last verified:** 2026-07-27  
**API touched:** Places API (New) — place, review and area summary fields  
**Probe:** Fetch the Places API (New) release notes and read the 2025-04-15 entry (Preview, no charge) and the 2025-05-08 entry (GA). Coverage expanded on 2025-08-21 to India, the UK and the US in English, and Japan in Japanese.
...
**Consequence:** Read the summary for your own business and your competitors — it is the closest thing to seeing what a Google model has concluded about a place. Requesting summary fields moves a Place Details call into a higher SKU tier ([LSM-PLACES-01](#lsm-places-01--2026-06-29--the-field-mask-decides-the-sku--same-call-0-or-35-per-1000)); they stopped being free when Preview ended.

### LSM-AI-03 · 2025-03-05 · AI Overviews in the US moved to Gemini 2.0

**Verdict:** WORKS  
**Last verified:** 2026-07-27  
**API touched:** AI Overviews generation layer — no API  
**Probe:** Google's 2025-03-05 announcement of the AI Overviews upgrade.

**Consequence:** The first of at least two documented model swaps inside fifteen months on the same surface. Treat the generation layer as versioned infrastructure you cannot see the version of.

### LSM-PLACES-06 · 2025-03-01 · Maps Platform pricing was restructured and legacy Places was frozen
...
**Consequence:** Cost-model per SKU, not per project, and read [LSM-PLACES-01](#lsm-places-01--2026-06-29--the-field-mask-decides-the-sku--same-call-0-or-35-per-1000) with it — the tier is chosen by your field mask. If you inherited code that calls a legacy Places endpoint, it will keep working in the project it was built in and cannot be enabled anywhere new.

## 2024

### LSM-PLACES-07 · 2024-11-07 · Pure service-area businesses became findable, if you ask
...
### LSM-GBP-05 · 2024-07-31 · Business Profile chat and call history were shut down

**Verdict:** GONE  
**Last verified:** 2026-07-27  
**API touched:** Google Business Messages; Business Profile call history  
**Probe:** Fetch `developers.google.com/business-communications/business-messages/resources/release-notes/update-on-gbm`. New chats stopped on 2024-07-15 and the feature ended on 2024-07-31; existing conversations were removed from the Maps inbox afterwards.
...
**Consequence:** Chat response rate and call-history counts are not recoverable and cannot be part of any reporting baseline. If you inherit a client whose historical reports contain them, say plainly that the source was retired rather than showing a series that flatlines.

### LSM-GBP-06 · 2024-07-01 · Health-provider attributes and insurance networks were discontinued
...
### LSM-PLACES-08 · 2024-05-28 · Autocomplete (New) reached GA with session-token billing
...
### LSM-PLACES-09 · 2024-05-13 · `maxResultCount` was deprecated in favour of `pageSize`
...
Limited Use applies to aggregated, anonymized and derived data, not only raw payloads. Use is confined to user-facing features prominent in the application's interface and to practices explicitly disclosed in the published privacy policy; all sale of the data is prohibited, including to data brokers, ad platforms and for retargeting or credit-worthiness. The policy contains no numeric retention cap of its own.
...
### LSM-GBP-07 · 2023-05-30 · The Business Calls API and location association were discontinued

**Verdict:** GONE  
**Last verified:** 2026-07-27  
**API touched:** My Business Business Calls API; `locations.associate`; `locations.clearLocationAssociation`  
**Probe:** Fetch `developers.google.com/my-business/content/sunset-dates`. Support ended 2023-02-21; discontinued 2023-05-30. Replacement column: **None**.
...
### LSM-POSTS-05 · 2023-03-30 · Per-post metrics left with `reportInsights` and never came back

**Verdict:** GONE  
**Last verified:** 2026-07-22  
**API touched:** v4 `accounts.locations.reportInsights` → replaced by `locations.fetchMultiDailyMetricsTimeSeries`; v4 `accounts.locations.localPosts.reportInsights`  
**Probe:** Fetch `developers.google.com/my-business/content/sunset-dates` — `accounts.locations.reportInsights` was deprecated 2022-11-21 and discontinued 2023-03-30. Then enumerate the metrics available from the Business Profile Performance API: there are eleven daily metrics and a monthly search-keywords endpoint, and **none of them is post-scoped**.
...
### LSM-PLACES-10 · 2023-05 · Autocomplete `bounds`, `location` and `radius` were deprecated
...
### LSM-PLACES-11 · 2020-05-26 · `permanently_closed` was deprecated, and tools still read it
...
### LSM-AI-04 · undated · The models behind the AI surfaces change without a changelog

**Verdict:** OPEN QUESTION  
**Last verified:** 2026-07-27  
**API touched:** AI Overviews, AI Mode, and every third-party assistant  
**Probe:** There is no probe that returns a version. Two model swaps on Google's surfaces are datable from announcements ([LSM-AI-03](#lsm-ai-03--2025-03-05--ai-overviews-in-the-us-moved-to-gemini-20), [LSM-AI-02](#lsm-ai-02--2025-05-20--gemini-25-went-under-ai-mode-and-ai-overviews)); the rest are not announced, and no vendor publishes a version identifier with a consumer answer.
