...
| --- | --- | --- | --- | --- |
| Place ID | Places | Yes | Indefinitely (refresh at 12 months) | [POLICY-08](#lsm-policy-08--place-ids-are-exempt-from-the-caching-restrictions-and-may-be-stored-indefinitely) |
| Latitude / longitude | Places | Yes | ≤ 30 consecutive calendar days, then delete | [POLICY-09](#lsm-policy-09--places-latitudelongitude-may-be-cached-for-30-consecutive-calendar-days-then-must-be-deleted) |
| Business name | Places | No | — | [POLICY-10](#lsm-policy-10--copying-and-saving-business-names-addresses-or-user-reviews-is-named-as-prohibited-scraping) |
| Address | Places | No | — | [POLICY-10](#lsm-policy-10--copying-and-saving-business-names-addresses-or-user-reviews-is-named-as-prohibited-scraping) |
| Rating, review count | Places | No | — | [POLICY-06](#lsm-policy-06--the-default-rule-for-places-content-is-no-caching-at-all) |
| Review text, author | Places | No | — | [POLICY-10](#lsm-policy-10--copying-and-saving-business-names-addresses-or-user-reviews-is-named-as-prohibited-scraping) |
| Opening hours, attributes, photo references | Places | No | — | [POLICY-06](#lsm-policy-06--the-default-rule-for-places-content-is-no-caching-at-all) |
| Any content from the Business Profile APIs | GBP | Limited amounts, for performance only | ≤ 30 calendar days, unaggregated | [POLICY-27](#lsm-policy-27--business-profile-api-content-is-capped-at-30-calendar-days-and-cannot-be-manipulated-or-aggregated) |
| The merchant's own reviews via their own OAuth grant | GBP | **Unsettled** | — | [POLICY-37](#lsm-policy-37--open--whether-the-30-day-gbp-cap-applies-to-a-merchants-own-data-under-their-own-oauth-grant) |
| Your own computed metrics (scores, positions, deltas) | Yours | Yes — but see the GBP aggregation wording | — | [POLICY-27](#lsm-policy-27--business-profile-api-content-is-capped-at-30-calendar-days-and-cannot-be-manipulated-or-aggregated), [POLICY-40](#lsm-policy-40--open--whether-a-rank-time-series-keyed-on-place-ids-is-google-maps-content) |
...
### LSM-POLICY-05 · Two separate regimes govern Google local data, and their rules do not transfer
...
### LSM-POLICY-07 · The "30-day Places caching allowance" does not exist in the terms
...
### LSM-POLICY-11 · Geocoding has an indefinite per-field caching grant that Places does not
...
### LSM-POLICY-12 · "Google Maps Content" is defined to include business listings
...
### LSM-POLICY-13 · On termination you must delete all content from the Services
...
### LSM-POLICY-14 · "Customer will not" is defined to include "will not permit a third party to"
...
### LSM-POLICY-15 · Using Google Maps Content to train, test, validate or fine-tune models is prohibited
...
Whether passing Places content through a model at inference time is caught is a separate and unsettled question — [LSM-POLICY-41](#lsm-policy-41--open--whether-inference-time-llm-use-of-google-maps-content-is-caught-by-the-training-prohibition).
...
### LSM-POLICY-16 · Point-in-polygon analysis on Places coordinates is named as prohibited content creation
...
**What to do instead:** Where the geometry question is about *your own* business or a customer-supplied service area, use coordinates you did not get from the Places API. Where it is about a competitor's location, note that the coordinate is both a 30-day-TTL field ([LSM-POLICY-09](#lsm-policy-09--places-latitudelongitude-may-be-cached-for-30-consecutive-calendar-days-then-must-be-deleted)) and a prohibited input to this specific analysis.

### LSM-POLICY-17 · Listings and directory services, and augmenting an advertising product, are prohibited uses
...
### LSM-POLICY-18 · Selling, reselling, sublicensing or distributing the Services is prohibited
...
### LSM-POLICY-19 · Places content may be shown without a map, but never with or near a non-Google map
...
### LSM-POLICY-20 · Modifying the Services' search results is prohibited
...
### LSM-POLICY-22 · Attribution is the Google Maps logo, with exact text as the space-constrained fallback
...
### LSM-POLICY-23 · Attribution must sit in the same visual container, and Google content must be visually distinguished
...
### LSM-POLICY-24 · Every displayed review and photo needs author attribution and a live link to the source on Google Maps
...
**Consequence:** The `googleMapsUri` requirement has an architectural implication that is easy to miss: a review displayed from a stale stored copy cannot reliably satisfy it, and a review printed into a static document cannot satisfy it at all unless the link is live and embedded. See [LSM-POLICY-39](#lsm-policy-39--open--whether-places-content-in-a-generated-pdf-or-email-is-display-or-storage) for the unsettled part.

### LSM-POLICY-25 · Review lists need an ordering and filtering notice, and France requires visitDate
...
### LSM-POLICY-26 · Your terms must bind users to the Google Maps End User Additional Terms, and flow that down
...
### LSM-POLICY-27 · Business Profile API content is capped at 30 calendar days and "cannot be manipulated or aggregated"
...
Four constraints, written unconditionally: **limited amounts**, **performance purpose only**, **30 calendar days**, **not manipulated or aggregated**. The text contains no exception for the merchant's own data obtained through the merchant's own OAuth grant — whether one should be read in is [LSM-POLICY-37](#lsm-policy-37--open--whether-the-30-day-gbp-cap-applies-to-a-merchants-own-data-under-their-own-oauth-grant), and it is the sharpest unresolved question in this chapter.
...
### LSM-POLICY-30 · No indirect or programmatic third-party access to your Business Profile project
...
**Consequence:** You may not require clients to get their own project, and you may not let them script against yours. Whether an agent acting for a signed-in user falls on the permitted or prohibited side is [LSM-POLICY-38](#lsm-policy-38--open--whether-an-ai-agent-acting-for-a-signed-in-user-satisfies-manually-sign-in), and it is unresolved.

### LSM-POLICY-31 · One customer's Business Profile data must not be compared with or shared with another customer
...
### LSM-POLICY-32 · The GoogleLocations endpoint may never be used for lead generation
...
### LSM-POLICY-33 · Seven business days to disassociate, 48 hours to disclose a change
...
### LSM-POLICY-34 · Limited Use covers data you derived or aggregated, not just raw API responses
...
### LSM-POLICY-35 · Tokens must be revoked and then permanently deleted, and encrypted at rest
...
### LSM-POLICY-36 · The User Data Policy sets no numeric retention cap and no deletion-on-revocation rule for data
...
The document has no clause stating how long OAuth-scope data may be kept, and none requiring deletion when a user revokes access. The token-deletion duty in [LSM-POLICY-35](#lsm-policy-35--tokens-must-be-revoked-and-then-permanently-deleted-and-encrypted-at-rest) is about tokens, not about the data those tokens fetched.

The retention obligations that do apply arrive indirectly: from the disclosed-practices limit in the same document (you may only do what your privacy policy says you do), and — for Business Profile data specifically — from the 30-day cap in [LSM-POLICY-27](#lsm-policy-27--business-profile-api-content-is-capped-at-30-calendar-days-and-cannot-be-manipulated-or-aggregated).
...
### LSM-POLICY-37 · OPEN · Whether the 30-day GBP cap applies to a merchant's own data under their own OAuth grant
...
### LSM-POLICY-38 · OPEN · Whether an AI agent acting for a signed-in user satisfies "manually sign in"
...
### LSM-POLICY-39 · OPEN · Whether Places content in a generated PDF or email is display or storage
...
### LSM-POLICY-40 · OPEN · Whether a rank time-series keyed on place IDs is Google Maps Content

**Verdict:** OPEN QUESTION
**Last verified:** 2026-07-16
**Source:** Google Maps Platform Terms of Service §3.2.3(a)–(c) and §20 (Definitions), last modified June 23, 2026

Rank tracking stores which place IDs appeared in which positions for a query, over time. Place IDs are storable indefinitely ([LSM-POLICY-08](#lsm-policy-08--place-ids-are-exempt-from-the-caching-restrictions-and-may-be-stored-indefinitely)) and a position you observed is arguably your own measurement rather than Google's content.
...
### LSM-POLICY-41 · OPEN · Whether inference-time LLM use of Google Maps Content is caught by the training prohibition
...
Against that: providers vary in whether API traffic can be retained or used for improvement, and a prompt that leaves your control is content you can no longer prove was not used for training. The prohibition is on *your* use, but §3.2 makes you answerable for third parties too ([LSM-POLICY-14](#lsm-policy-14--customer-will-not-is-defined-to-include-will-not-permit-a-third-party-to)).
...
### LSM-POLICY-42 · EEA-billed customers are governed by separate documents not read here
