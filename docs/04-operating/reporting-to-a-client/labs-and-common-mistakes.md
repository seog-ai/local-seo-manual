...
Three labs put the rest of this chapter into practice: write the page before you look at the numbers, grade a report you did not write, and fix the cadence while nothing is riding on it.
...
**Leading with the profile score.** It is a diagnostic input, and a completeness audit that cannot see distance ([Diagnosing a business in thirty minutes](../../02-core-practice/analyzing-business-visibility/index.md)). Put it on the front page and the client starts optimising it — ticking low-weight attribute boxes — and you taught them to.
...
4. **You inherit last quarter's report from a previous supplier. Which two rubric checks do you run first, and why those?** ([What you inherit with a client](../what-you-inherit-with-a-client/index.md) covers the rest of the handover.)
...
**Next:** [The ninety-day plan →](../the-ninety-day-plan/index.md)
